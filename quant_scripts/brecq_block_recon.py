...
from quant_scripts.brecq_data_utils import save_grad_data, save_inp_oup_data_block, save_inp_oup_data


def block_reconstruction_two_input(model: QuantModel, block, cali_images:torch.Tensor, cali_t:torch.Tensor, cali_y:torch.Tensor,
...
def block_reconstruction_single_input(model: QuantModel, block, cali_images:torch.Tensor, cali_t:torch.Tensor, cali_y:torch.Tensor,
